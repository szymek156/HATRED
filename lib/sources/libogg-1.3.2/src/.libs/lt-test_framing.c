...
/* ./.libs/lt-test_framing.c - temporary wrapper executable for .libs/test_framing
...
const char * TARGET_PROGRAM_NAME = "test_framing"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test_framing - temporary wrapper script for .libs/test_framing\n", f);
  ...
  fputs ("    echo \"test_framing:test_framing:${LINENO}: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_framing:test_framing:${LINENO}: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_framing:test_framing:${LINENO}: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);

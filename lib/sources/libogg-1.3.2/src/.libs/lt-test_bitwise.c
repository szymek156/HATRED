...
/* ./.libs/lt-test_bitwise.c - temporary wrapper executable for .libs/test_bitwise
...
const char * TARGET_PROGRAM_NAME = "test_bitwise"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test_bitwise - temporary wrapper script for .libs/test_bitwise\n", f);
  ...
  fputs ("    echo \"test_bitwise:test_bitwise:${LINENO}: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_bitwise:test_bitwise:${LINENO}: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_bitwise:test_bitwise:${LINENO}: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
